...
public:	
	std::vector<long> m_vectFeaturesInProximity;
	std::vector<long> m_vectFeaturesInProximityByCmnAttVal; 
	std::vector<long> m_vectInterPolyFeaturesInProximity; // vector to store intermediate features on polyline verices
	std::vector<long> m_vectFeaturesInProximityAtNode2;  // Used in case of Linear feature	
...
typedef std::map<long, CNSValidationDataCollector*> VALIDATE_COL_MAP_TYPE;